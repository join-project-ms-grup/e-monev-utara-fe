...
const RKPD_PaguTable = () => {
  ...
  const { data, refetch, isFetching } = useQuery({
    queryKey: ['rkpd_tabel_pagu', selectedSKPD],
    queryFn: async () => {
      const pagu = await getPaguRKPD(Number(selectedSKPD));
  ...
  useEffect(() => {
    if (!openModal) {
      ...
      console.log('RKPD_PaguTable.tsx', formData);
    }
  }, [openModal]);
  //#endregion
